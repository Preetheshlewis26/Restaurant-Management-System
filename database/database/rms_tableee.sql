...
CREATE TABLE `tableee` (
  ...
  `ttable` int NOT NULL,
  `ttidd` int NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `tableee` WRITE;
/*!40000 ALTER TABLE `tableee` DISABLE KEYS */;
INSERT INTO `tableee` VALUES ('plplplp','95959595','1','2023-09-15','11.00 A.M','BOOK',3,1,'RES8979');
/*!40000 ALTER TABLE `tableee` ENABLE KEYS */;
UNLOCK TABLES;
