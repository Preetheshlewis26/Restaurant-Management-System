...
public class totalsales extends javax.swing.JFrame {
    ...
    public void table()
        {
            try 
            {
                String sql = "SELECT sname AS ItemName,sprice AS Price,squantity AS Quantity,scashs AS Cash,sbalances AS Balance,date AS Date,sid AS BillNumber,stotalamou AS TotalAmount FROM allsale";
       ...
       public void search()
        {
            ...
            try 
            {
             String sql = "SELECT sname AS ItemName,sprice AS Price,squantity AS Quantity,scashs AS Cash,sbalances AS Balance,date AS Date,sid AS BillNumber,stotalamou AS TotalAmount FROM allsale WHERE sid LIKE '%"+sea+"%'OR sname LIKE '%"+sea+"%'";  
             sss = sos.prepareStatement(sql);
             rs = sss.executeQuery();
             jTable1.setModel(DbUtils.resultSetToTableModel(rs));
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "      ItemName", "       ItemPrice", "       Quantity", "   TotalAmount", "         Cash", "        Balance", "        Date", "         ID"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    	try
        {
            ...
            rs=sss.executeQuery();
            if(rs.next()) {
                afterlog sy = new afterlog (name);
                sy.setVisible(true);
                this.dispose();
            }else {
            	afteremp sy = new afteremp (name);
                sy.setVisible(true);
                this.dispose();
            }
        } catch (Exception e)
