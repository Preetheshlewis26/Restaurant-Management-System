...
public class stuff extends javax.swing.JFrame {
    ...
    public void getdata() {
    	 try 
         {
    		 String sql = "SELECT * FROM regis WHERE rname=? and ruser=?";
             sss = sos.prepareStatement(sql);
             sss.setString(1,namebox.getText());
             sss.setString(2,unamebox.getText());
             rs = sss.executeQuery();
             if(rs.next()) {
 ...
 public void table()
        {
            try 
            {
                String sql = "SELECT rname AS Name,runame as Username,rposition AS Position,rphone AS Phone,rsection AS Section,rid AS ID,raddress AS Address,rage AS Age,rnic AS NIC,rdate AS JobStarted FROM staff_details ";
                sss = sos.prepareStatement(sql);
                rs = sss.executeQuery();
        ...
        public void search()
        {
            ...
            try 
            {
             String sql = "SELECT rname AS Name,runame as Username,rposition AS Position,rphone AS Phone,rsection AS Section,rid AS ID,raddress AS Address,rage AS Age,rnic AS NIC,rdate AS JobStarted FROM staff_details WHERE rname LIKE '%"+nnn+"%'OR rid LIKE '%"+nnn+"%'";  
             sss = sos.prepareStatement(sql);
             rs = sss.executeQuery();
             jTable1.setModel(DbUtils.resultSetToTableModel(rs));
            }
        ...
        public void update ()
        {
          ...
          String date = sdf.format(datebox.getDate());
            ...
            try 
            {
                String sql = "UPDATE staff_details SET rname = '"+name+"',ruser = '"+uname+"',rposition ='"+position+"',rphone ='"+phone+"',rsection ='"+section+"',raddress ='"+address+"',rage ='"+age+"',rnic ='"+idnumber+"',rdate ='"+date+"' WHERE rid = '"+id+"'";
                sss = sos.prepareStatement(sql);
                sss.execute();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "            Name","     Username", "         Position", "     Phone Number", "      Section", "      ID"
            }
        ));
        ...
        idnbox.setFont(new java.awt.Font("", 1, 15)); // NOI18N
        
        jPanel2.add(idnbox);
        idnbox.setBounds(220, 200, 220, 30);
        ...
        jPanel2.add(getdata);
        getdata.setBounds(220, 338, 100, 30);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(unamebox, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel32))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel2.add(jPanel1);
        jPanel1.setBounds(20, 80, 350, 340);
    ...
    private void unameboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nameboxActionPerformed
        // TODO add your handling code here:
    }
    private void getdatabuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearbuttonActionPerformed
        getdata();
    }
    private void deletebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebuttonActionPerformed
        ...
        if (check == 0)
        {
          String uname = unamebox.getText();
            ...
            try 
            {
                String sql = "DELETE FROM staff_details WHERE rname = '"+uname+"'"; 
    ...
    public void tables()
        {
            ...
            String position = jTable1.getValueAt(r,2).toString();
            String phone = jTable1.getValueAt(r,3).toString();
            String section = jTable1.getValueAt(r,4).toString();
            String id = jTable1.getValueAt(r,5).toString();
             String address = jTable1.getValueAt(r,6).toString();
              String age = jTable1.getValueAt(r,7).toString();
               String idnumber = jTable1.getValueAt(r,8).toString();
    ...
    private void insertbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertbuttonActionPerformed
       ...
       idnumber = idnbox.getText();
        ...
        try 
        {
            String sen = "INSERT INTO staff_details (rname ,runame ,rposition ,rphone ,rsection,raddress,rage,rnic,rdate,Mid) VALUES ('"+name+"','"+uname+"','"+position+"','"+phone+"','"+section+"','"+address+"','"+age+"','"+idnumber+"','"+date+"','"+name1+"')";
    ...
    private javax.swing.JLabel idnbox;
