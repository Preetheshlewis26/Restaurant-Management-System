...
public class room extends javax.swing.JFrame {
    ...
    public void table()
        ...
        public void search()
        {
            ...
            try 
            {
             String sql = "SELECT rname AS Name,rphone AS Phone,ridnumber AS NIC,raddress AS Address,rroom AS Room,rdate AS Date,ravala AS Availability,rrid AS ID FROM room WHERE rname LIKE '%"+iii+"%'OR rdate LIKE '%"+iii+"%'";  
             sss = sos.prepareStatement(sql);
             rs = sss.executeQuery();
             jTable1.setModel(DbUtils.resultSetToTableModel(rs));
            }
       ...
       String idddd = iddd.getText();
            ...
            {	
                	...
                	String sql = "UPDATE room SET rname = '"+name+"',rphone ='"+phone+"',ridnumber ='"+idnumber+"',raddress ='"+address+"',rroom ='"+room+"',rdate='"+date+"',ravala='"+avala+"',Eid='"+name1+"'  WHERE rrid ='"+idddd+"'";
                    sss = sos.prepareStatement(sql);
                    sss.execute();
    ...
    private void bookbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookbuttonActionPerformed
       ...
       avala = jComboBox1.getSelectedItem().toString();
        ...
        try 
        {	
        	String iii = "INSERT INTO room (rname ,rphone ,ridnumber ,raddress,rroom,rdate,ravala,Eid) VALUES ('"+name+"','"+phone+"','"+idnumber+"','"+address+"','"+room+"','"+date+"','"+avala+"','"+name1+"')";
