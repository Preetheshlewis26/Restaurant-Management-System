...
public class food extends javax.swing.JFrame {
 ...
 public void table()
        ...
        public void search()
        {
            ...
            try 
            {
             String sql = "SELECT fname AS Name,ftype AS Type ,fprice AS Price, fid AS ID FROM food WHERE fname LIKE '%"+sea+"%'OR fid LIKE '%"+sea+"%'";  
             sss = sos.prepareStatement(sql);
             rs = sss.executeQuery();
             jTable1.setModel(DbUtils.resultSetToTableModel(rs));
            }
        ...
        public void update ()
        {
          ...
          String id = idbox.getText();
            ...
            try 
            {	
            	String sql = "UPDATE food SET fname = '"+name+"',ftype ='"+type+"',fprice ='"+price+"',fid = '"+id+"',Eid = '"+name1+"' WHERE fid = '"+id+"'";
                sss = sos.prepareStatement(sql);
                sss.execute();
    ...
    private void insertbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertbuttonActionPerformed
       ...
       price = Integer.parseInt(pricebox.getText());
        ...
        {	
        	...
        	String sen = "INSERT INTO food (fname ,ftype ,fprice,Eid) VALUES ('"+name+"','"+type+"','"+price+"','"+name1+"')";
