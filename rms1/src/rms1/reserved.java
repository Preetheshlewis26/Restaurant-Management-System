...
public void table()
        {
            try 
            {
                String sql = "SELECT tname AS Name,tphone AS Phone,tid AS ID,tdate AS Date,ttime AS Time,ttable AS Tnumber,availability AS Availability,ttidd AS BillNumber FROM tableee ";
        ...
        public void search()
        {
            ...
            try 
            {
             String sql = "SELECT tname AS Name,tphone AS Phone,tid AS ID,tdate AS Date,ttime AS Time,ttable AS Tnumber,availability AS Availability,ttidd AS BillNumber FROM tableee WHERE tname LIKE '%"+nnn+"%'OR tdate LIKE '%"+nnn+"%'";  
             sss = sos.prepareStatement(sql);
             rs = sss.executeQuery();
             jTable1.setModel(DbUtils.resultSetToTableModel(rs));
            }
        ...
        public void update ()
        {
            ...
            try 
            {	
            	String sql = "UPDATE tableee SET tname = '"+name+"',tphone ='"+phone+"',tid ='"+id+"',tdate ='"+date+"',ttime ='"+time+"',ttable ='"+table+"',availability ='"+avala+"' ,Eid ='"+rs1+"' WHERE ttidd = '"+iddtt+"'";
                sss = sos.prepareStatement(sql);
                sss.execute();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       avala = availabox.getSelectedItem().toString();
        ...
        try 
        {	String sql = "INSERT INTO tableee (tname ,tphone ,tid ,tdate,ttime,ttable,availability,Eid) VALUES ('"+name+"','"+phone+"','"+id+"','"+date+"','"+time+"','"+table+"','"+avala+"','"+rs1+"')";
            sss = sos.prepareStatement(sql);
            sss.execute();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
    	try
        {
            ...
            rs=sss.executeQuery();
            if(rs.next()) {
                afterlog sy = new afterlog (rs1);
                sy.setVisible(true);
                this.dispose();
            }else {
            	afteremp sy = new afteremp (rs1);
                sy.setVisible(true);
                this.dispose();
            }
        } catch (Exception e)
